...
LPF15kHz::LPF15kHz(uint32_t bufsize) {
	...
	sos1 = new SOS(0.11638, 1.00000, 2.003378, 1.003390, 0.816897, 0.633795);
	sos2 = new SOS(0.11638, 1.00000, 1.996591, 0.996603, 0.620204, 0.240408);
	sos3 = new SOS(0.11638, 1.00000, 2.000030, 1.000019, 0.544509, 0.089018);
